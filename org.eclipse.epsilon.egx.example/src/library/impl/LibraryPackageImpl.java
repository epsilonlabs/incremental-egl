...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	 ...
	 * @generated
	 */
	public EReference getWriter_Titles() {
	...
	public void createPackageContents() {
		...
		createEReference(writerEClass, WRITER__TITLES);
	...
	public void initializePackageContents() {
		...
		initEReference(getWriter_Titles(), this.getBook(), this.getBook_Author(), "titles", null, 0, -1, Writer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBook_Author(), this.getWriter(), this.getWriter_Titles(), "author", null, 0, -1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
