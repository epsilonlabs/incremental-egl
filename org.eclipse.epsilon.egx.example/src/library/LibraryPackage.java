...
public interface LibraryPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the reference list '{@link library.Writer#getTitles <em>Titles</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Titles</em>'.
	 * @see library.Writer#getTitles()
	 * @see #getWriter()
	 * @generated
	 */
	EReference getWriter_Titles();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference WRITER__TITLES = eINSTANCE.getWriter_Titles();
