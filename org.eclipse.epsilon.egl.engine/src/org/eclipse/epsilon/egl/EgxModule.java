...
public class EgxModule extends ErlModule implements IEolExecutableModule, IEglModule {
	...
	public static void main(String[] args) throws Exception {
		...
		module.parse("rule C2J transform c : EClass { signature: Set{'name'} target: 1+2+'c' pre {'pre'.println();'pre1'.println();}  post{'post'.println();} }");
	...
	public boolean parse(String code, File file) throws Exception {
		...
		if (result && file != null) templateFactory.initialiseRoot(file.getParentFile().toURI());
		return result;
	}
