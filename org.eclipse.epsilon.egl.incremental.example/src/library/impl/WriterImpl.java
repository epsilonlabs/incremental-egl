 ...
 *   <li>{@link library.impl.WriterImpl#getTitles <em>Titles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WriterImpl extends EObjectImpl implements Writer {
	 ...
	 * @generated
	 */
	public EList<Book> getTitles() {
		if (titles == null) {
			titles = new EObjectWithInverseResolvingEList.ManyInverse<Book>(Book.class, this, LibraryPackage.WRITER__TITLES, LibraryPackage.BOOK__AUTHOR);
		}
		return titles;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LibraryPackage.WRITER__TITLES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case LibraryPackage.WRITER__TITLES:
				getTitles().clear();
				getTitles().addAll((Collection<? extends Book>)newValue);
				return;
		}
